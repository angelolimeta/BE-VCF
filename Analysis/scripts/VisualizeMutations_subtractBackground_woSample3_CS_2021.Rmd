---
title: "Visualise base editing data, w/o WT sample 3"
...
df_seq %>% 
  ...
  filter(!is.na(MUT_ENRICH)) %>%
  mutate(ID = "ID") %>% 
  summarise(quantile = scales::percent(c(0.25, 0.999)),
            MUT_ENRICH_quant = quantile(MUT_ENRICH, c(0.25, 0.999)))
```
